...
class PatRegPage extends StatefulWidget {
  @override
  _PatRegState createState() => _PatRegState();
}

class PatForm extends StatefulWidget {
  @override
  PatFormState createState() {
    return PatFormState();
  }
}
...
class _PatRegState extends State<PatRegPage> {
  @override
            ...
            child: Builder(
                builder: (context) => Scaffold(
                      ...
                      appBar: AppBar(
                        ...
                        title: Text(
                            arabic ? 'تسجيل مريض' : 'Patient Register'),
                        centerTitle: true,
                      ),
                      body: PatForm(),
                    ))));
...
class PatFormState extends State<PatForm> {
